...
public class ChoosePanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jsWolf.setModel(new javax.swing.SpinnerNumberModel(0, 0, 1000, 1));
        getContentPane().add(jsWolf);
        jsWolf.setBounds(360, 380, 80, 30);

        jsNinja.setModel(new javax.swing.SpinnerNumberModel(0, 0, 1000, 1));
        getContentPane().add(jsNinja);
        jsNinja.setBounds(670, 380, 70, 30);

        jsTroll.setModel(new javax.swing.SpinnerNumberModel(0, 0, 1000, 1));
        getContentPane().add(jsTroll);
        jsTroll.setBounds(990, 380, 80, 30);

        lblfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/wall.jpg"))); // NOI18N
        getContentPane().add(lblfondo);
        lblfondo.setBounds(-90, 0, 1410, 800);
    ...
    private void playMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_playMouseClicked
        if (!jrbWolf.isSelected() && !jrbNinja.isSelected() && !jrbTroll.isSelected()) {
            ...
            if (jrbHard.isSelected()) {
                ...
                w.setVisible(true);
                w.getHardMazePanel2().addCharacters((int)jsWolf.getValue(), 
                        (int)jsNinja.getValue(), 
                        (int)jsTroll.getValue());
            } else if (jrbnormal.isSelected()) {
                WindowNormal wn = new WindowNormal();
                wn.setVisible(true);
                wn.getNormalMazePanel1().addCharacters((int)jsWolf.getValue(), 
                        (int)jsNinja.getValue(), 
                        (int)jsTroll.getValue());
            } else {
                WindowEasy we = new WindowEasy();
                we.setVisible(true);
                we.getMazePanel1().addCharacters((int)jsWolf.getValue(), 
                        (int)jsNinja.getValue(), 
                        (int)jsTroll.getValue());
            }
